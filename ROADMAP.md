...
- [ ] M14-M21 -- Tier 1: shakedown, notification agents, health + indexer stats, custom formats, upgrades, failed-download handling, season packs, Android search + push -- planned, see [docs/tier1-plan.md](docs/tier1-plan.md)
