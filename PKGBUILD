...
depends=('python' 'libtorrent-rasterbar' 'chromium' 'ffmpeg')  # chromium: the built-in Cloudflare solver for public trackers (app/indexers/solver.py); ffmpeg: ffprobe and subtitle extraction for playback (M49)
